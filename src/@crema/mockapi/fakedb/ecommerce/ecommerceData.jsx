...
const ecommerceData = [
  {
    ...
    Item: "1",
    product_Title:
      'DNA 28" Silver and Black Aluminium Alloy Lightweight Baseball Softball Rounders Bat Full Size Adults and Teens',
...
export const recentOrders = [
  {
    ...
    product_name:
      "Brouette de pêche à la carpe avec sac de transport intégré en acier robuste et corps réglable",
    sku: "P-DNA-BARROW-01",
    item_status: "Shipped",
    quantity: "1",
    currency: "EUR",
